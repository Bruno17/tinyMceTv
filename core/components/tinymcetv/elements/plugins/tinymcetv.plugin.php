...
switch ($modx->event->name) {
    ...
    case 'OnRichTextBrowserInit':
            ...
            //does currently not working together with a second richtext-editor using thie same event.
...
$corePath = $modx->getOption('tinymcetv.core_path', null, $modx->getOption('core_path') . 'components/tinymcetv/');
